                          ...
                          <div class="wrap_form">
                            <form action="index.php?ctl=cambiar_contra" method="POST" class="formulario" name="formu">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color:#BDBDBD; border:2px solid #BDBDBD;">Cerrar</button>
                                <input type="submit" class="btn btn-success" value="Guardar cambios" style="border-radius: .25rem">
                              </div>
                            </form>
                          </div>
                        </div>
